...
import io.github.jhipster.application.repository.TipoEventoRepository;
...
class TipoEventoResourceIT {
  ...
  void createTipoEvento() throws Exception {
    ...
    assertThat(testTipoEvento.getIdTipoEvento())
      .isEqualTo(DEFAULT_ID_TIPO_EVENTO);
    assertThat(testTipoEvento.getDsTipoEvento())
      .isEqualTo(DEFAULT_DS_TIPO_EVENTO);
  }
  ...
  void getAllTipoEventos() throws Exception {
    ...
    restTipoEventoMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(tipoEvento.getId().intValue()))
      )
      .andExpect(
      ...
      .andExpect(
        jsonPath("$.[*].dsTipoEvento").value(hasItem(DEFAULT_DS_TIPO_EVENTO))
      );
  }
  ...
  void getTipoEvento() throws Exception {
    ...
    restTipoEventoMockMvc
      ...
      .andExpect(
        jsonPath("$.idTipoEvento").value(DEFAULT_ID_TIPO_EVENTO.intValue())
      )
  ...
  void putNewTipoEvento() throws Exception {
    ...
    TipoEvento updatedTipoEvento = tipoEventoRepository
    ...
    TipoEvento testTipoEvento = tipoEventoList.get(tipoEventoList.size() - 1);
    assertThat(testTipoEvento.getIdTipoEvento())
      .isEqualTo(UPDATED_ID_TIPO_EVENTO);
    assertThat(testTipoEvento.getDsTipoEvento())
      .isEqualTo(UPDATED_DS_TIPO_EVENTO);
  }
  ...
  void deleteTipoEvento() throws Exception {
    ...
    restTipoEventoMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, tipoEvento.getId())
