...
import io.github.jhipster.application.repository.ProduttoreRepository;
...
class ProduttoreResourceIT {
  ...
  void createProduttore() throws Exception {
    ...
    assertThat(testProduttore.getIdProduttore())
      .isEqualTo(DEFAULT_ID_PRODUTTORE);
    assertThat(testProduttore.getDsProduttore())
      .isEqualTo(DEFAULT_DS_PRODUTTORE);
  }
  ...
  void getAllProduttores() throws Exception {
    ...
    restProduttoreMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(produttore.getId().intValue()))
      )
      .andExpect(
      ...
      .andExpect(
        jsonPath("$.[*].dsProduttore").value(hasItem(DEFAULT_DS_PRODUTTORE))
      );
  }
  ...
  void getProduttore() throws Exception {
    ...
    restProduttoreMockMvc
      ...
      .andExpect(
        jsonPath("$.idProduttore").value(DEFAULT_ID_PRODUTTORE.intValue())
      )
  ...
  void putNewProduttore() throws Exception {
    ...
    Produttore updatedProduttore = produttoreRepository
    ...
    Produttore testProduttore = produttoreList.get(produttoreList.size() - 1);
    assertThat(testProduttore.getIdProduttore())
      .isEqualTo(UPDATED_ID_PRODUTTORE);
    assertThat(testProduttore.getDsProduttore())
      .isEqualTo(UPDATED_DS_PRODUTTORE);
  }
  ...
  void deleteProduttore() throws Exception {
    ...
    restProduttoreMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, produttore.getId())
