...
import io.github.jhipster.application.repository.TransizioniRepository;
...
class TransizioniResourceIT {
  ...
  void createTransizioni() throws Exception {
    ...
    Transizioni testTransizioni = transizioniList.get(
      transizioniList.size() - 1
    );
    assertThat(testTransizioni.getIdTransizione())
      .isEqualTo(DEFAULT_ID_TRANSIZIONE);
    assertThat(testTransizioni.getDsTransizione())
      .isEqualTo(DEFAULT_DS_TRANSIZIONE);
  }
  ...
  void getAllTransizionis() throws Exception {
    ...
    restTransizioniMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(transizioni.getId().intValue()))
      )
      .andExpect(
      ...
      .andExpect(
        jsonPath("$.[*].dsTransizione").value(hasItem(DEFAULT_DS_TRANSIZIONE))
      );
  }
  ...
  void getTransizioni() throws Exception {
    ...
    restTransizioniMockMvc
      ...
      .andExpect(
        jsonPath("$.idTransizione").value(DEFAULT_ID_TRANSIZIONE.intValue())
      )
  ...
  void putNewTransizioni() throws Exception {
    ...
    Transizioni updatedTransizioni = transizioniRepository
    ...
    assertThat(testTransizioni.getIdTransizione())
      .isEqualTo(UPDATED_ID_TRANSIZIONE);
    assertThat(testTransizioni.getDsTransizione())
      .isEqualTo(UPDATED_DS_TRANSIZIONE);
  }
  ...
  void deleteTransizioni() throws Exception {
    ...
    restTransizioniMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, transizioni.getId())
