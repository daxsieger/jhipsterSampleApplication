...
class AssistitoResourceIT {
  ...
  void getAllAssistitos() throws Exception {
    ...
    restAssistitoMockMvc
      ...
      .andExpect(
        jsonPath("$.[*].id").value(hasItem(assistito.getId().intValue()))
      )
      .andExpect(
  ...
  void getAssistito() throws Exception {
    ...
    restAssistitoMockMvc
      ...
      .andExpect(
        jsonPath("$.idAssistito").value(DEFAULT_ID_ASSISTITO.intValue())
      );
  }
  ...
  void putNewAssistito() throws Exception {
    ...
    Assistito updatedAssistito = assistitoRepository
  ...
  void deleteAssistito() throws Exception {
    ...
    restAssistitoMockMvc
      .perform(
        delete(ENTITY_API_URL_ID, assistito.getId())
