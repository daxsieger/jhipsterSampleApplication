...
describe("Gestore Management Component", () => {
  let comp: GestoreComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GestoreComponent, "")
      .compileComponents();
  ...
  it("Should call load all on init", () => {
    ...
    expect(comp.gestores[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
