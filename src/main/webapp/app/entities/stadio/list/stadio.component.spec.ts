...
describe("Stadio Management Component", () => {
  let comp: StadioComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StadioComponent, "")
      .compileComponents();
  ...
  it("Should call load all on init", () => {
    ...
    expect(comp.stadios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
