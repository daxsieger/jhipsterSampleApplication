...
describe("Produttore Management Component", () => {
  let comp: ProduttoreComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProduttoreComponent, "")
      .compileComponents();
  ...
  it("Should call load all on init", () => {
    ...
    expect(comp.produttores?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
