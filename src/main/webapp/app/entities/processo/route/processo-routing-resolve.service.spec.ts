...
describe("Processo routing resolve service", () => {
  ...
  let resultProcesso: IProcesso | undefined;
  ...
  describe("resolve", () => {
    ...
    it("should return new IProcesso if id is not provided", () => {
      // GIVEN
      ...
      expect(resultProcesso).toEqual(new Processo());
    });
    ...
    it("should route to 404 page if data not found in server", () => {
      ...
      jest
        .spyOn(service, "find")
        .mockReturnValue(
          of(new HttpResponse({ body: null as unknown as Processo }))
        );
      mockActivatedRouteSnapshot.params = { id: 123 };
