...
describe("Evento Management Update Component", () => {
  ...
  describe("ngOnInit", () => {
    it("Should call assistito query and add missing value", () => {
      ...
      jest
        .spyOn(assistitoService, "query")
        .mockReturnValue(of(new HttpResponse({ body: assistitoCollection })));
      const expectedCollection: IAssistito[] = [
        assistito,
        ...assistitoCollection,
      ];
      jest
        .spyOn(assistitoService, "addAssistitoToCollectionIfMissing")
      ...
      expect(
        assistitoService.addAssistitoToCollectionIfMissing
      ).toHaveBeenCalledWith(assistitoCollection, assistito);
    ...
    it("Should call tipo query and add missing value", () => {
      ...
      jest
        .spyOn(tipoEventoService, "query")
        .mockReturnValue(of(new HttpResponse({ body: tipoCollection })));
      const expectedCollection: ITipoEvento[] = [tipo, ...tipoCollection];
      jest
        .spyOn(tipoEventoService, "addTipoEventoToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
      ...
      expect(
        tipoEventoService.addTipoEventoToCollectionIfMissing
      ).toHaveBeenCalledWith(tipoCollection, tipo);
    ...
    it("Should call gestore query and add missing value", () => {
      ...
      jest
        .spyOn(gestoreService, "query")
        .mockReturnValue(of(new HttpResponse({ body: gestoreCollection })));
      const expectedCollection: IGestore[] = [gestore, ...gestoreCollection];
      jest
        .spyOn(gestoreService, "addGestoreToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
      ...
      expect(
        gestoreService.addGestoreToCollectionIfMissing
      ).toHaveBeenCalledWith(gestoreCollection, gestore);
    ...
    it("Should call Produttore query and add missing value", () => {
      ...
      jest
        .spyOn(produttoreService, "query")
        .mockReturnValue(of(new HttpResponse({ body: produttoreCollection })));
      const additionalProduttores = [origine];
      const expectedCollection: IProduttore[] = [
        ...additionalProduttores,
        ...produttoreCollection,
      ];
      jest
        .spyOn(produttoreService, "addProduttoreToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
      ...
      expect(
        produttoreService.addProduttoreToCollectionIfMissing
      ).toHaveBeenCalledWith(produttoreCollection, ...additionalProduttores);
    ...
    it("Should call Stato query and add missing value", () => {
      ...
      jest
        .spyOn(statoService, "query")
        .mockReturnValue(of(new HttpResponse({ body: statoCollection })));
      const additionalStatoes = [...statis];
      const expectedCollection: IStato[] = [
        ...additionalStatoes,
        ...statoCollection,
      ];
      jest
        .spyOn(statoService, "addStatoToCollectionIfMissing")
        .mockReturnValue(expectedCollection);
      ...
      expect(statoService.addStatoToCollectionIfMissing).toHaveBeenCalledWith(
        statoCollection,
        ...additionalStatoes
      );
