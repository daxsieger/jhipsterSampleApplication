...
import io.github.jhipster.application.repository.ProcessoRepository;
import io.github.jhipster.application.service.ProcessoService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Processo}.
 */
@RestController
@RequestMapping("/api")
public class ProcessoResource {
  ...
  public ResponseEntity<Processo> createProcesso(
    ...
    if (processo.getId() != null) {
      throw new BadRequestAlertException(
        "A new processo cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
  ...
  public ResponseEntity<Processo> partialUpdateProcesso(
    ...
    log.debug(
      "REST request to partial update Processo partially : {}, {}",
      id,
      processo
    );
    if (processo.getId() == null) {
