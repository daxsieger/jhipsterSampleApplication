...
import io.github.jhipster.application.repository.StadioRepository;
import io.github.jhipster.application.service.StadioService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Stadio}.
 */
@RestController
@RequestMapping("/api")
public class StadioResource {
   ...
   */
  @PostMapping("/stadios")
  public ResponseEntity<Stadio> createStadio(@RequestBody Stadio stadio)
    throws URISyntaxException {
    log.debug("REST request to save Stadio : {}", stadio);
    if (stadio.getId() != null) {
      throw new BadRequestAlertException(
        "A new stadio cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
  ...
  public ResponseEntity<Stadio> updateStadio(
  ...
  public ResponseEntity<Stadio> partialUpdateStadio(
    ...
    log.debug(
      "REST request to partial update Stadio partially : {}, {}",
      id,
      stadio
    );
    if (stadio.getId() == null) {
   ...
   */
  @GetMapping("/stadios")
  public ResponseEntity<List<Stadio>> getAllStadios(
