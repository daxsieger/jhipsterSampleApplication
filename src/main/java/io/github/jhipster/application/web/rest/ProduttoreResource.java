...
import io.github.jhipster.application.service.ProduttoreService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Produttore}.
 */
@RestController
@RequestMapping("/api")
public class ProduttoreResource {
  ...
  public ResponseEntity<Produttore> partialUpdateProduttore(
    ...
    log.debug(
      "REST request to partial update Produttore partially : {}, {}",
      id,
      produttore
    );
    if (produttore.getId() == null) {
  ...
  public ResponseEntity<List<Produttore>> getAllProduttores(
