...
import io.github.jhipster.application.repository.GestoreRepository;
import io.github.jhipster.application.service.GestoreService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Gestore}.
 */
@RestController
@RequestMapping("/api")
public class GestoreResource {
  ...
  public ResponseEntity<Gestore> createGestore(@RequestBody Gestore gestore)
    throws URISyntaxException {
    log.debug("REST request to save Gestore : {}", gestore);
    if (gestore.getId() != null) {
      throw new BadRequestAlertException(
        "A new gestore cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
  ...
  public ResponseEntity<Gestore> updateGestore(
  ...
  public ResponseEntity<Gestore> partialUpdateGestore(
    ...
    log.debug(
      "REST request to partial update Gestore partially : {}, {}",
      id,
      gestore
    );
    if (gestore.getId() == null) {
   ...
   */
  @GetMapping("/gestores")
  public ResponseEntity<List<Gestore>> getAllGestores(
