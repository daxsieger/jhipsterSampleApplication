...
import io.github.jhipster.application.repository.AssistitoRepository;
import io.github.jhipster.application.service.AssistitoService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Assistito}.
 */
@RestController
@RequestMapping("/api")
public class AssistitoResource {
  ...
  public AssistitoResource(
    AssistitoService assistitoService,
    AssistitoRepository assistitoRepository
  ) {
  ...
  public ResponseEntity<Assistito> partialUpdateAssistito(
    ...
    log.debug(
      "REST request to partial update Assistito partially : {}, {}",
      id,
      assistito
    );
    if (assistito.getId() == null) {
  ...
  public ResponseEntity<List<Assistito>> getAllAssistitos(
