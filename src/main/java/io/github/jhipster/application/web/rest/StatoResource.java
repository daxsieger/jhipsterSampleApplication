...
import io.github.jhipster.application.repository.StatoRepository;
import io.github.jhipster.application.service.StatoService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Stato}.
 */
@RestController
@RequestMapping("/api")
public class StatoResource {
   ...
   */
  @PostMapping("/statoes")
  public ResponseEntity<Stato> createStato(@RequestBody Stato stato)
    throws URISyntaxException {
    log.debug("REST request to save Stato : {}", stato);
    if (stato.getId() != null) {
      throw new BadRequestAlertException(
        "A new stato cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
  ...
  public ResponseEntity<Stato> updateStato(
  ...
  public ResponseEntity<Stato> partialUpdateStato(
    @PathVariable(value = "id", required = false) final Long id,
    @RequestBody Stato stato
  ) throws URISyntaxException {
    log.debug(
      "REST request to partial update Stato partially : {}, {}",
      id,
      stato
    );
    if (stato.getId() == null) {
   ...
   */
  @GetMapping("/statoes")
  public ResponseEntity<List<Stato>> getAllStatoes(
