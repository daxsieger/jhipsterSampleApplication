...
import io.github.jhipster.application.service.TransizioniService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Transizioni}.
 */
@RestController
@RequestMapping("/api")
public class TransizioniResource {
  ...
  public TransizioniResource(
    TransizioniService transizioniService,
    TransizioniRepository transizioniRepository
  ) {
  ...
  public ResponseEntity<Transizioni> createTransizioni(
    ...
    if (transizioni.getId() != null) {
      throw new BadRequestAlertException(
        "A new transizioni cannot already have an ID",
        ENTITY_NAME,
        "idexists"
      );
    }
  ...
  public ResponseEntity<Transizioni> partialUpdateTransizioni(
    ...
    log.debug(
      "REST request to partial update Transizioni partially : {}, {}",
      id,
      transizioni
    );
    if (transizioni.getId() == null) {
    ...
    Optional<Transizioni> result = transizioniService.partialUpdate(
      transizioni
    );
  ...
  public ResponseEntity<List<Transizioni>> getAllTransizionis(
