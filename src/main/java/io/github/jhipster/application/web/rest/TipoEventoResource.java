...
import io.github.jhipster.application.service.TipoEventoService;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.TipoEvento}.
 */
@RestController
@RequestMapping("/api")
public class TipoEventoResource {
  ...
  public ResponseEntity<TipoEvento> partialUpdateTipoEvento(
    ...
    log.debug(
      "REST request to partial update TipoEvento partially : {}, {}",
      id,
      tipoEvento
    );
    if (tipoEvento.getId() == null) {
